...
BT_icon_list = {'BT_Left.png', 
    ...
    Walking_Direction_Icon_Location_P11_Up = [486, 537 ];
    Walking_Direction_Icon_Location_P11_Down = [530,847 ];
    Walking_Direction_Icon_Location_P12_Left = [448,549 ];
    Walking_Direction_Icon_Location_P12_Right = [601,578 ];
    Walking_Direction_Icon_Location_P14_Up = [343,592 ];
    Walking_Direction_Icon_Location_P14_Down = [395,735 ];
    Walking_Direction_Icon_Location_P15_Left = [186,690 ];
    Walking_Direction_Icon_Location_P15_Right = [514,734 ];
    Walking_Direction_Icon_Location_P16_Up = [232,591 ];
    Walking_Direction_Icon_Location_P16_Down = [280,850 ];
    Walking_Direction_Icon_Location_P18_Up = [129,169 ];
    Walking_Direction_Icon_Location_P18_Down = [174, 340];
